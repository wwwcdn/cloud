...
var width=450;
var height=320;
var wt=(screen.height-height)/2; 
var wl=(screen.width-width)/2; 
 function toQzoneLogin()
 {
   var A=window.open("/oauth/redirect_to_login.php","TencentLogin","width="+width+",height="+height+",top="+wt+",left="+wl+ ",menubar=0,scrollbars=0,resizable=0,status=0,titlebar=0,toolbar=0,location=0");
 }

//QQ登录绑定表单提交
function bind_submit()
{
    if (document.getElementById("bindlogin").style.display != "none")
    {
        document.getElementById("frmloginqq").submit();
    }
    else
    {
